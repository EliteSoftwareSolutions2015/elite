...
/*
try{
                String host = "smtp8.net4india.com";
...
//              String from = request.getParameter("Email");
                ...
                messagetext = messagetext + "User Name:" + Name;
                messagetext = messagetext + "Company:" + Company;
                messagetext = messagetext + "Email:" + from;
                messagetext = messagetext + "Phone:" + Phone;
                messagetext = messagetext + "EmailID:" + EmailId;
                messagetext = messagetext + "Country:" + Country;
                messagetext = messagetext + "Service" + Service;
                messagetext = messagetext + "Details" + Details;
                messagetext = messagetext + "usercode" + usercode;
...
*/
         ...
         try{
                 ...
                 message.println("Subject:  User Enquiry Email");
                 message.println("This was sent from a Enquiry Page!");
                 message.println();
                 message.println("Name:" + " " + Name);
                 message.println();
                 message.println("Company:" + " " + Company);
                 message.println();
                 message.println("Email:" + " " + EmailId);
                 message.println();
                 message.println("Phone:" + " " + Phone);
                 message.println();
                 message.println("Country:" + " " + Country);
                 message.println();
                 message.println("Service:" + " " + Service);
                 message.println();
                 message.println("Details:" + " " + Details);
                 message.println();
                 message.println("Usercode:" + " " + usercode);
                 message.println();
                 message.flush();
                 message.close();   
