...
*/
        ...
        //        String from = request.getParameter("Email");
            ...
            try{
                     ...
                     message.println("Subject:  User Quick Contact");
                     message.println("This was sent from a Quick Contact Form!");
                     message.println();
                            ...
                            <table width="100%" cellpadding="5" cellspacing="5">
                                    <tbody><tr>
                                            ...
                                            <p style="padding-left: 0px; text-align: center;"><span style="color: red">&nbsp;</span>
                                                ...
                                                <input class="Buttonrefresh" type="button" value="Refresh Image" onClick="window.location.href=window.location.href"/>
