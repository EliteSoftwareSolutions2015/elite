...
(function($) {
	...
	// a number - indicates an immediate transition should occur to the given
	// slide index
	// a string - 'pause', 'resume', 'toggle', 'next', 'prev', 'stop', 'destroy'
	// or the name of a transition effect (ie, 'fade', 'zoom', etc)
	...
	function buildOptions($cont, $slides, els, options, o) {
		...
		$slides
				.each(function() {
					...
					if ($el.is('img')) {
						// sigh.. sniffing, hacking, shrugging... this crappy
						// hack tries to account for what browsers do when
						// an image is being downloaded and the markup did not
						// include sizing info (height/width attributes);
						// there seems to be some "default" sizes used in this
						// situation
	...
	$.fn.cycle.defaults = {
		...
		timeout : 4000, // milliseconds between slide transitions (0 to disable
						// auto advance)
		...
		next : null, // selector for element to use as event trigger for next
						// slide
		prev : null, // selector for element to use as event trigger for
						// previous slide
		// prevNextClick: null, // @deprecated; please use onPrevNextEvent
		// instead
		onPrevNextEvent : null, // callback fn for prev/next events:
								// function(isNext, zeroBasedSlideIndex,
								// slideElement)
		prevNextEvent : 'click.cycle',// event which drives the manual
										// transition to the previous or next
										// slide
		pager : null, // selector for element to use as pager container
		// pagerClick null, // @deprecated; please use onPagerEvent instead
		onPagerEvent : null, // callback fn for pager events:
								// function(zeroBasedSlideIndex, slideElement)
		pagerEvent : 'click.cycle', // name of event which drives the pager
									// navigation
		...
		before : null, // transition callback (scope set to element to be
						// shown): function(currSlideElement, nextSlideElement,
						// options, forwardFlag)
		after : null, // transition callback (scope set to element that was
						// shown): function(currSlideElement, nextSlideElement,
						// options, forwardFlag)
		end : null, // callback invoked when the slideshow terminates (use with
					// autostop or nowrap options): function(options)
		...
		fxFn : null, // function used to control the transition:
						// function(currSlideElement, nextSlideElement, options,
						// afterCalback, forwardFlag)
		height : 'auto', // container height
		startingSlide : 0, // zero-based index of the first slide to be
							// displayed
		sync : 1, // true if in/out transitions should occur simultaneously
		random : 0, // true for random, false for sequence (not applicable to
					// shuffle fx)
		...
		updateActivePagerLink : null, // callback fn invoked to update the
										// active pager link (adds/removes
										// activePagerClass style)
		backwards : false
	// true to start slideshow at last slide and move backwards through the
	// stack
	};
